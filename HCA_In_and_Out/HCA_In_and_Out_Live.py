...
permanent_file = p / f'in_and_out_live_state.csv'
IS_FIRST_DAY = False
...
def initialize(context):
    ...
    c.STOCKS = symbols('IWB' , 'QQQ'); c.BONDS = symbols('IEF'); c.LEV = 0.95; c.wt = {};        
    ...
    c.MKT = symbol('QQQ'); c.VOLA = 126; c.LB = 0.95; c.BULL = 0; c.COUNT = 0; c.OUT_DAY = 0; c.RET_INITIAL = 80;
    #c.IS_PERSIST = True
   ...
   # -----------------------------------------------------------------------------------------------
    ...
    # Read persistent c.traded_cf or create if non exists,
...
def trade(context,data,wts):
    ...
    print("{} Market Time: Trading done for today".format(mkt_time))
